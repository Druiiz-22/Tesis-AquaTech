...
public class Registro extends JPanel implements properties.Colores, properties.Constantes{
    ...
    /**
     * Función para vaciar todos los campos del registro de usuarios y
     * los datos de usuarios almacenados.
     */
     ...
     * @param type Tipo de ventana que será mostrada 
     * (DATOS, CORREO, CODIGO o CLAVE).
     */
    ...
    /**
     * Función para guardar el correo electrónico del usuario
     * en la clase de registro, luego de ser confirmado.
    ...
    /**
     * Función para guardar la contraseña del usuario en la 
     * clase de registro.
